...
public class WeaponManagerEditor : Editor
{
    ...
    private SerializedProperty weaponRest;
    ...
    private void OnEnable()
    {
        ...
        this.weaponGrip = serializedObject.FindProperty("weaponGrip");
        this.weaponRest = serializedObject.FindProperty("weaponRest");
    ...
    {
        // Disable the script field to avoid editing the script reference
        ...
        EditorGUILayout.PropertyField(weaponRest);
        ...
        // Display the weaponItems list as a single item
